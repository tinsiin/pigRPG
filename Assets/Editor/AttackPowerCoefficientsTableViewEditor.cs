...
[CustomEditor(typeof(AttackPowerCoefficientsTableView))]
public class AttackPowerCoefficientsTableViewEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        var view = (AttackPowerCoefficientsTableView)target;
        ...
        using (new EditorGUI.DisabledScope(EditorApplication.isPlaying))
        {
            ...
            {
                Undo.RecordObject(view, "Bake AttackPower Table Data");
                view.BakeDataFromCurrent();
                EditorUtility.SetDirty(view);
            }
        }
        // いつでもクリア可能: ベイク有無/プレイ中でも視覚オブジェクトの掃除が必要なため
        ...
        bool hasBaked = view != null && view.HasBakedDataForEditor();
