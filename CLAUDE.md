...
### メモの性質
- メモはユーザーが認知負荷を下げるために書いた**抽象的・概念的なもの**。詳細な定義や正確な仕様はdocフォルダの仕様書に書かれている
- 設計の想起・着想の記録としての側面が強い。実装の正確な反映ではない
- 実際に仕様書化や実装が進んだ領域については、ユーザーがセッション内で対話を重ねて仕様を固めているため、**メモの記述が古くなっていたり的外れになっている場合がある**。メモとdoc/コードで食い違いがあればdoc/コード側が正
